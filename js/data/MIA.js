...
window.SEASON_DATA = {
  ...
  "2025-26": {
    ...
    conf_rank: 10,
    games: buildGames(
      "LWWWLLWLWWWLLWWWWWWLWLLLLLWLLLWWWWLWLLLWLWLWLWWLWLWLLWLWWWLLWWWWWWWLLLLLWLLWLWL",
      ["Orlando Magic", "Memphis Grizzlies", "New York Knicks", "Charlotte Hornets", "San Antonio Spurs", "Los Angeles Lakers", "Los Angeles Clippers", "Denver Nuggets", "Charlotte Hornets", "Portland Trail Blazers", "Cleveland Cavaliers", "Cleveland Cavaliers", "New York Knicks", "New York Knicks", "Golden State Warriors", "Chicago Bulls", "Philadelphia 76ers", "Dallas Mavericks", "Milwaukee Bucks", "Detroit Pistons", "Los Angeles Clippers", "Dallas Mavericks", "Orlando Magic", "Sacramento Kings", "Orlando Magic", "Toronto Raptors", "Brooklyn Nets", "Boston Celtics", "New York Knicks", "Toronto Raptors", "Atlanta Hawks", "Indiana Pacers", "Denver Nuggets", "Detroit Pistons", "Minnesota Timberwolves", "New Orleans Pelicans", "Minnesota Timberwolves", "Indiana Pacers", "Oklahoma City Thunder", "Phoenix Suns", "Boston Celtics", "Oklahoma City Thunder", "Golden State Warriors", "Sacramento Kings", "Portland Trail Blazers", "Utah Jazz", "Phoenix Suns", "Orlando Magic", "Chicago Bulls", "Chicago Bulls", "Chicago Bulls", "Atlanta Hawks", "Boston Celtics", "Washington Wizards", "Utah Jazz", "New Orleans Pelicans", "Atlanta Hawks", "Memphis Grizzlies", "Milwaukee Bucks", "Philadelphia 76ers", "Houston Rockets", "Brooklyn Nets", "Brooklyn Nets", "Charlotte Hornets", "Detroit Pistons", "Washington Wizards", "Milwaukee Bucks", "Orlando Magic", "Charlotte Hornets", "Los Angeles Lakers", "Houston Rockets", "San Antonio Spurs", "Cleveland Cavaliers", "Cleveland Cavaliers", "Indiana Pacers", "Philadelphia 76ers", "Boston Celtics", "Washington Wizards", "Toronto Raptors"],
      [121, 146, 115, 144, 101, 120, 120, 112, 126, 136, 140, 116, 132, 115, 110, 143, 127, 106, 106, 135, 140, 108, 105, 111, 108, 96, 106, 116, 125, 91, 126, 142, 147, 118, 115, 125, 94, 99, 112, 127, 114, 122, 112, 130, 110, 147, 111, 124, 116, 118, 134, 115, 96, 132, 111, 123, 128, 136, 117, 117, 115, 124, 126, 128, 121, 150, 112, 117, 106, 126, 122, 111, 120, 128, 118, 119, 129, 152, 95],
      [-4, 32, 8, 27, -6, -10, 1, -10, 18, 5, 2, -14, -8, 2, 14, 36, 10, 4, 3, -3, 17, -10, -1, -16, -9, -10, 11, -13, -7, -21, 15, 26, 24, 6, -10, 19, -28, -24, -12, 6, -5, 2, -23, 13, -17, 31, 9, -9, 3, -7, 43, -12, -2, 31, -4, 12, 31, 16, -11, -7, 10, 26, 16, 8, 11, 21, 7, -4, -30, -8, -1, -25, 17, -21, -17, 10, -18, 16, -26]
    ),
    leaders: {
      pts: { name: "Norman Powell", val: 21.9, all: [{"name": "Norman Powell", "val": 21.9}, {"name": "Tyler Herro", "val": 21.2}, {"name": "Bam Adebayo", "val": 20.0}, {"name": "Andrew Wiggins", "val": 15.8}, {"name": "Jaime Jaquez Jr.", "val": 15.1}, {"name": "Pelle Larsson", "val": 11.3}, {"name": "Kel'el Ware", "val": 11.0}, {"name": "Davion Mitchell", "val": 9.2}, {"name": "Simone Fontecchio", "val": 8.3}, {"name": "Nikola Jović", "val": 7.3}, {"name": "Kasparas Jakučionis", "val": 6.1}, {"name": "Dru Smith", "val": 5.6}, {"name": "Myron Gardner", "val": 3.8}, {"name": "Keshad Johnson", "val": 3.7}, {"name": "Jahmir Young", "val": 1.8}, {"name": "Vladislav Goldin", "val": 0.7}, {"name": "Trevor Keels", "val": 0.0}] },
      reb: { name: "Bam Adebayo", val: 10.0, all: [{"name": "Bam Adebayo", "val": 10.0}, {"name": "Kel'el Ware", "val": 9.1}, {"name": "Jaime Jaquez Jr.", "val": 5.1}, {"name": "Andrew Wiggins", "val": 5.0}, {"name": "Tyler Herro", "val": 4.6}, {"name": "Norman Powell", "val": 3.6}, {"name": "Pelle Larsson", "val": 3.5}, {"name": "Nikola Jović", "val": 3.3}, {"name": "Simone Fontecchio", "val": 3.0}, {"name": "Myron Gardner", "val": 2.8}, {"name": "Davion Mitchell", "val": 2.7}, {"name": "Kasparas Jakučionis", "val": 2.6}, {"name": "Dru Smith", "val": 2.5}, {"name": "Keshad Johnson", "val": 1.8}, {"name": "Vladislav Goldin", "val": 0.8}, {"name": "Jahmir Young", "val": 0.4}, {"name": "Trevor Keels", "val": 0.4}] },
      ast: { name: "Davion Mitchell", val: 6.5, all: [{"name": "Davion Mitchell", "val": 6.5}, {"name": "Jaime Jaquez Jr.", "val": 4.7}, {"name": "Tyler Herro", "val": 4.0}, {"name": "Pelle Larsson", "val": 3.4}, {"name": "Bam Adebayo", "val": 3.0}, {"name": "Andrew Wiggins", "val": 2.7}, {"name": "Dru Smith", "val": 2.6}, {"name": "Kasparas Jakučionis", "val": 2.6}, {"name": "Norman Powell", "val": 2.5}, {"name": "Nikola Jović", "val": 2.2}, {"name": "Simone Fontecchio", "val": 1.4}, {"name": "Myron Gardner", "val": 1.0}, {"name": "Kel'el Ware", "val": 0.7}, {"name": "Jahmir Young", "val": 0.5}, {"name": "Vladislav Goldin", "val": 0.3}, {"name": "Keshad Johnson", "val": 0.1}, {"name": "Trevor Keels", "val": 0.0}] },
      stl: { name: "Dru Smith", val: 1.4, all: [{"name": "Dru Smith", "val": 1.4}, {"name": "Bam Adebayo", "val": 1.2}, {"name": "Andrew Wiggins", "val": 1.1}, {"name": "Norman Powell", "val": 1.1}, {"name": "Davion Mitchell", "val": 1.0}, {"name": "Kel'el Ware", "val": 0.8}, {"name": "Jaime Jaquez Jr.", "val": 0.7}, {"name": "Pelle Larsson", "val": 0.7}, {"name": "Tyler Herro", "val": 0.7}, {"name": "Kasparas Jakučionis", "val": 0.6}, {"name": "Nikola Jović", "val": 0.6}, {"name": "Simone Fontecchio", "val": 0.5}, {"name": "Myron Gardner", "val": 0.5}, {"name": "Keshad Johnson", "val": 0.4}, {"name": "Jahmir Young", "val": 0.1}, {"name": "Vladislav Goldin", "val": 0.0}, {"name": "Trevor Keels", "val": 0.0}] },
      blk: { name: "Kel'el Ware", val: 1.1, all: [{"name": "Kel'el Ware", "val": 1.1}, {"name": "Andrew Wiggins", "val": 1.0}, {"name": "Bam Adebayo", "val": 0.6}, {"name": "Tyler Herro", "val": 0.4}, {"name": "Nikola Jović", "val": 0.4}, {"name": "Keshad Johnson", "val": 0.3}, {"name": "Norman Powell", "val": 0.3}, {"name": "Jaime Jaquez Jr.", "val": 0.3}, {"name": "Vladislav Goldin", "val": 0.3}, {"name": "Dru Smith", "val": 0.3}, {"name": "Davion Mitchell", "val": 0.2}, {"name": "Pelle Larsson", "val": 0.2}, {"name": "Myron Gardner", "val": 0.2}, {"name": "Kasparas Jakučionis", "val": 0.1}, {"name": "Simone Fontecchio", "val": 0.1}, {"name": "Jahmir Young", "val": 0.0}, {"name": "Trevor Keels", "val": 0.0}] },
    },
    avail: [
      { name: "Kel'el Ware", g: 74 },
      { name: "Jaime Jaquez Jr.", g: 72 },
      { name: "Bam Adebayo", g: 70 },
      { name: "Dru Smith", g: 70 },
      { name: "Simone Fontecchio", g: 69 },
      { name: "Davion Mitchell", g: 68 },
      { name: "Pelle Larsson", g: 68 },
      { name: "Andrew Wiggins", g: 65 },
      { name: "Norman Powell", g: 56 },
      { name: "Kasparas Jakučionis", g: 50 },
      { name: "Nikola Jović", g: 47 },
      { name: "Myron Gardner", g: 42 },
      { name: "Tyler Herro", g: 31 },
      { name: "Keshad Johnson", g: 29 },
      { name: "Jahmir Young", g: 11 },
      { name: "Vladislav Goldin", g: 6 },
      { name: "Trevor Keels", g: 5 },
    ]
  },
