...
window.SEASON_DATA = {
  ...
  "2025-26": {
    ...
    conf_rank: 8,
    games: buildGames(
      "WLLLLWWLWLWWWLWWWLWWWLWLWLLWLWLWLWLWLWLWWLLLLWWLLWWWLWLWWLLWWWWWWWLLLLLLWLWLWWWWWL",
      ["Miami Heat", "Atlanta Hawks", "Chicago Bulls", "Philadelphia 76ers", "Detroit Pistons", "Charlotte Hornets", "Washington Wizards", "Atlanta Hawks", "Boston Celtics", "Boston Celtics", "Portland Trail Blazers", "New York Knicks", "Brooklyn Nets", "Houston Rockets", "Golden State Warriors", "Los Angeles Clippers", "New York Knicks", "Boston Celtics", "Philadelphia 76ers", "Detroit Pistons", "Chicago Bulls", "San Antonio Spurs", "Miami Heat", "New York Knicks", "Miami Heat", "New York Knicks", "Denver Nuggets", "Utah Jazz", "Golden State Warriors", "Portland Trail Blazers", "Charlotte Hornets", "Denver Nuggets", "Toronto Raptors", "Indiana Pacers", "Chicago Bulls", "Indiana Pacers", "Washington Wizards", "Brooklyn Nets", "Philadelphia 76ers", "New Orleans Pelicans", "Memphis Grizzlies", "Memphis Grizzlies", "Charlotte Hornets", "Cleveland Cavaliers", "Cleveland Cavaliers", "Miami Heat", "Toronto Raptors", "San Antonio Spurs", "Oklahoma City Thunder", "Brooklyn Nets", "Utah Jazz", "Milwaukee Bucks", "Milwaukee Bucks", "Sacramento Kings", "Phoenix Suns", "Los Angeles Clippers", "Los Angeles Lakers", "Houston Rockets", "Detroit Pistons", "Washington Wizards", "Dallas Mavericks", "Minnesota Timberwolves", "Milwaukee Bucks", "Cleveland Cavaliers", "Washington Wizards", "Miami Heat", "Atlanta Hawks", "Oklahoma City Thunder", "Charlotte Hornets", "Los Angeles Lakers", "Indiana Pacers", "Cleveland Cavaliers", "Sacramento Kings", "Toronto Raptors", "Phoenix Suns", "Atlanta Hawks", "Dallas Mavericks", "New Orleans Pelicans", "Detroit Pistons", "Minnesota Timberwolves", "Chicago Bulls", "Boston Celtics"],
      [125, 107, 98, 124, 116, 123, 125, 112, 123, 107, 115, 124, 105, 113, 121, 129, 133, 129, 144, 112, 125, 112, 106, 100, 117, 120, 115, 128, 97, 110, 105, 127, 106, 112, 114, 135, 112, 104, 91, 128, 118, 109, 97, 105, 98, 133, 130, 103, 92, 118, 120, 118, 108, 131, 110, 111, 110, 108, 92, 126, 115, 119, 130, 128, 136, 121, 112, 108, 111, 104, 126, 131, 121, 87, 115, 101, 138, 112, 123, 132, 127, 108],
      [4, -4, -12, -12, -19, 16, 31, -15, 13, -4, 3, 17, 7, -4, 8, 28, 12, -9, 41, 3, 5, -2, 1, -6, 9, -12, -11, 1, -23, 4, -15, 1, -1, 2, -7, 8, -8, 1, -12, 10, 7, -17, -27, -14, -16, 9, 10, -9, -36, 20, 3, 19, -8, 37, -3, 2, 1, -5, -14, 17, 1, 27, 39, 6, 5, 4, -12, -5, -19, -1, -2, -5, 4, -52, 4, -29, 11, 4, 16, 12, 24, -5]
    ),
    leaders: {
      pts: { name: "Paolo Banchero", val: 22.2, all: [{"name": "Paolo Banchero", "val": 22.2}, {"name": "Franz Wagner", "val": 20.6}, {"name": "Desmond Bane", "val": 20.1}, {"name": "Anthony Black", "val": 15.0}, {"name": "Jalen Suggs", "val": 13.8}, {"name": "Wendell Carter Jr.", "val": 11.8}, {"name": "Tristan Da Silva", "val": 9.9}, {"name": "Jevon Carter", "val": 7.2}, {"name": "Moritz Wagner", "val": 6.9}, {"name": "Goga Bitadze", "val": 5.9}, {"name": "Jett Howard", "val": 5.5}, {"name": "Jamal Cain", "val": 5.4}, {"name": "Jase Richardson", "val": 4.4}, {"name": "Noah Penda", "val": 3.8}, {"name": "Tyus Jones", "val": 3.0}, {"name": "Jonathan Isaac", "val": 2.6}, {"name": "Alex Morales", "val": 2.0}, {"name": "Orlando Robinson", "val": 1.8}, {"name": "Colin Castleton", "val": 1.3}] },
      reb: { name: "Paolo Banchero", val: 8.4, all: [{"name": "Paolo Banchero", "val": 8.4}, {"name": "Wendell Carter Jr.", "val": 7.4}, {"name": "Franz Wagner", "val": 5.2}, {"name": "Goga Bitadze", "val": 5.0}, {"name": "Desmond Bane", "val": 4.1}, {"name": "Jalen Suggs", "val": 3.9}, {"name": "Anthony Black", "val": 3.8}, {"name": "Tristan Da Silva", "val": 3.7}, {"name": "Noah Penda", "val": 3.2}, {"name": "Moritz Wagner", "val": 3.2}, {"name": "Jonathan Isaac", "val": 2.5}, {"name": "Jevon Carter", "val": 2.1}, {"name": "Colin Castleton", "val": 2.0}, {"name": "Jamal Cain", "val": 2.0}, {"name": "Jett Howard", "val": 1.6}, {"name": "Jase Richardson", "val": 1.2}, {"name": "Tyus Jones", "val": 1.1}, {"name": "Orlando Robinson", "val": 1.0}, {"name": "Alex Morales", "val": 0.8}] },
      ast: { name: "Jalen Suggs", val: 5.5, all: [{"name": "Jalen Suggs", "val": 5.5}, {"name": "Paolo Banchero", "val": 5.2}, {"name": "Desmond Bane", "val": 4.1}, {"name": "Anthony Black", "val": 3.7}, {"name": "Franz Wagner", "val": 3.3}, {"name": "Tyus Jones", "val": 2.4}, {"name": "Jevon Carter", "val": 2.3}, {"name": "Wendell Carter Jr.", "val": 2.0}, {"name": "Tristan Da Silva", "val": 1.6}, {"name": "Goga Bitadze", "val": 1.3}, {"name": "Noah Penda", "val": 1.2}, {"name": "Jase Richardson", "val": 1.1}, {"name": "Alex Morales", "val": 1.0}, {"name": "Moritz Wagner", "val": 0.8}, {"name": "Jett Howard", "val": 0.8}, {"name": "Orlando Robinson", "val": 0.8}, {"name": "Jamal Cain", "val": 0.7}, {"name": "Jonathan Isaac", "val": 0.4}, {"name": "Colin Castleton", "val": 0.3}] },
      stl: { name: "Jalen Suggs", val: 1.8, all: [{"name": "Jalen Suggs", "val": 1.8}, {"name": "Anthony Black", "val": 1.4}, {"name": "Desmond Bane", "val": 1.0}, {"name": "Tristan Da Silva", "val": 0.9}, {"name": "Franz Wagner", "val": 0.9}, {"name": "Jevon Carter", "val": 0.9}, {"name": "Wendell Carter Jr.", "val": 0.8}, {"name": "Paolo Banchero", "val": 0.7}, {"name": "Tyus Jones", "val": 0.7}, {"name": "Goga Bitadze", "val": 0.6}, {"name": "Noah Penda", "val": 0.5}, {"name": "Jase Richardson", "val": 0.4}, {"name": "Moritz Wagner", "val": 0.4}, {"name": "Jonathan Isaac", "val": 0.4}, {"name": "Jamal Cain", "val": 0.3}, {"name": "Colin Castleton", "val": 0.3}, {"name": "Orlando Robinson", "val": 0.3}, {"name": "Jett Howard", "val": 0.2}, {"name": "Alex Morales", "val": 0.0}] },
      blk: { name: "Goga Bitadze", val: 1.0, all: [{"name": "Goga Bitadze", "val": 1.0}, {"name": "Anthony Black", "val": 0.7}, {"name": "Jalen Suggs", "val": 0.7}, {"name": "Jonathan Isaac", "val": 0.6}, {"name": "Wendell Carter Jr.", "val": 0.6}, {"name": "Paolo Banchero", "val": 0.6}, {"name": "Desmond Bane", "val": 0.5}, {"name": "Franz Wagner", "val": 0.3}, {"name": "Tristan Da Silva", "val": 0.3}, {"name": "Noah Penda", "val": 0.3}, {"name": "Jevon Carter", "val": 0.3}, {"name": "Jett Howard", "val": 0.2}, {"name": "Tyus Jones", "val": 0.1}, {"name": "Moritz Wagner", "val": 0.1}, {"name": "Jamal Cain", "val": 0.1}, {"name": "Jase Richardson", "val": 0.0}, {"name": "Orlando Robinson", "val": 0.0}, {"name": "Alex Morales", "val": 0.0}, {"name": "Colin Castleton", "val": 0.0}] },
    },
    avail: [
      { name: "Desmond Bane", g: 82 },
      { name: "Wendell Carter Jr.", g: 78 },
      { name: "Tristan Da Silva", g: 77 },
      { name: "Paolo Banchero", g: 72 },
      { name: "Anthony Black", g: 64 },
      { name: "Goga Bitadze", g: 64 },
      { name: "Noah Penda", g: 59 },
      { name: "Jalen Suggs", g: 57 },
      { name: "Jett Howard", g: 55 },
      { name: "Jase Richardson", g: 54 },
      { name: "Jonathan Isaac", g: 52 },
      { name: "Tyus Jones", g: 48 },
      { name: "Jamal Cain", g: 40 },
      { name: "Moritz Wagner", g: 36 },
      { name: "Franz Wagner", g: 34 },
      { name: "Jevon Carter", g: 30 },
      { name: "Orlando Robinson", g: 4 },
      { name: "Alex Morales", g: 4 },
      { name: "Colin Castleton", g: 4 },
    ]
  },
