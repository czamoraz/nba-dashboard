...
window.SEASON_DATA = {
  ...
  "2025-26": {
    ...
    conf_rank: 5,
    games: buildGames(
      "WLLLLWWWWLWWWWWWWWWLLWLLLLWWLLWLWWLWWWLWLWLLWWWWLLWLWWLWWLLWLLWLLWWWLLWLWWLLWLWWLW",
      ["Atlanta Hawks", "Milwaukee Bucks", "Dallas Mavericks", "San Antonio Spurs", "Houston Rockets", "Cleveland Cavaliers", "Memphis Grizzlies", "Milwaukee Bucks", "Atlanta Hawks", "Philadelphia 76ers", "Brooklyn Nets", "Cleveland Cavaliers", "Indiana Pacers", "Charlotte Hornets", "Philadelphia 76ers", "Washington Wizards", "Brooklyn Nets", "Cleveland Cavaliers", "Indiana Pacers", "Charlotte Hornets", "New York Knicks", "Portland Trail Blazers", "Los Angeles Lakers", "Charlotte Hornets", "Boston Celtics", "New York Knicks", "Miami Heat", "Milwaukee Bucks", "Boston Celtics", "Brooklyn Nets", "Miami Heat", "Washington Wizards", "Golden State Warriors", "Orlando Magic", "Denver Nuggets", "Atlanta Hawks", "Atlanta Hawks", "Charlotte Hornets", "Boston Celtics", "Philadelphia 76ers", "Philadelphia 76ers", "Indiana Pacers", "Los Angeles Clippers", "Los Angeles Lakers", "Golden State Warriors", "Sacramento Kings", "Portland Trail Blazers", "Oklahoma City Thunder", "New York Knicks", "Orlando Magic", "Utah Jazz", "Minnesota Timberwolves", "Chicago Bulls", "Indiana Pacers", "Detroit Pistons", "Chicago Bulls", "Milwaukee Bucks", "Oklahoma City Thunder", "San Antonio Spurs", "Washington Wizards", "New York Knicks", "Minnesota Timberwolves", "Dallas Mavericks", "Houston Rockets", "New Orleans Pelicans", "Phoenix Suns", "Detroit Pistons", "Chicago Bulls", "Denver Nuggets", "Phoenix Suns", "Utah Jazz", "Los Angeles Clippers", "New Orleans Pelicans", "Orlando Magic", "Detroit Pistons", "Sacramento Kings", "Memphis Grizzlies", "Boston Celtics", "Miami Heat", "Miami Heat", "New York Knicks", "Brooklyn Nets"],
      [138, 116, 129, 103, 121, 112, 117, 128, 109, 120, 119, 126, 129, 110, 121, 140, 119, 110, 97, 111, 94, 121, 120, 86, 113, 101, 106, 111, 96, 81, 112, 117, 141, 107, 103, 134, 118, 97, 117, 116, 102, 115, 117, 93, 145, 122, 110, 103, 92, 120, 107, 126, 123, 122, 95, 110, 122, 107, 107, 134, 95, 107, 122, 99, 111, 122, 119, 139, 115, 98, 143, 94, 119, 139, 116, 115, 128, 101, 121, 128, 95, 136],
      [20, -6, -10, -18, -18, 11, 13, 28, 12, -10, 10, 13, 18, 2, 9, 30, 10, 11, 2, -7, -22, 3, -3, -25, -8, -16, 10, 6, -16, -15, 21, -21, 14, 1, -3, 17, 18, 1, -8, 1, -13, 14, -4, -17, 18, 13, 12, 2, -27, -10, 7, -2, 16, 18, -18, 9, 28, -9, -3, 9, -16, -8, 30, -14, -11, 7, 11, 30, -6, -22, 16, -25, 13, 52, -11, -8, 32, -14, 26, 14, -17, 35]
    ),
    leaders: {
      pts: { name: "Brandon Ingram", val: 21.5, all: [{"name": "Brandon Ingram", "val": 21.5}, {"name": "RJ Barrett", "val": 19.3}, {"name": "Scottie Barnes", "val": 18.1}, {"name": "Immanuel Quickley", "val": 16.4}, {"name": "Sandro Mamukelashvili", "val": 11.2}, {"name": "Jakob Poeltl", "val": 10.7}, {"name": "Collin Murray-Boyles", "val": 8.5}, {"name": "Ja'Kobe Walter", "val": 7.5}, {"name": "Jamal Shead", "val": 6.6}, {"name": "Gradey Dick", "val": 6.0}, {"name": "Ochai Agbaji", "val": 4.3}, {"name": "A.J. Lawson", "val": 4.2}, {"name": "Jamison Battle", "val": 3.1}, {"name": "Alijah Martin", "val": 2.2}, {"name": "Trayce Jackson-Davis", "val": 1.8}, {"name": "Jonathan Mogbo", "val": 1.5}, {"name": "Garrett Temple", "val": 0.8}, {"name": "Markelle Fultz", "val": 0.8}, {"name": "Chucky Hepburn", "val": 0.0}, {"name": "Mo Bamba", "val": 0.0}] },
      reb: { name: "Scottie Barnes", val: 7.5, all: [{"name": "Scottie Barnes", "val": 7.5}, {"name": "Jakob Poeltl", "val": 7.0}, {"name": "Brandon Ingram", "val": 5.6}, {"name": "RJ Barrett", "val": 5.3}, {"name": "Collin Murray-Boyles", "val": 5.0}, {"name": "Sandro Mamukelashvili", "val": 4.9}, {"name": "Immanuel Quickley", "val": 4.0}, {"name": "Ja'Kobe Walter", "val": 2.6}, {"name": "Ochai Agbaji", "val": 2.3}, {"name": "Gradey Dick", "val": 1.9}, {"name": "Trayce Jackson-Davis", "val": 1.9}, {"name": "A.J. Lawson", "val": 1.8}, {"name": "Jamal Shead", "val": 1.7}, {"name": "Jonathan Mogbo", "val": 1.7}, {"name": "Jamison Battle", "val": 1.5}, {"name": "Mo Bamba", "val": 1.0}, {"name": "Alijah Martin", "val": 0.9}, {"name": "Chucky Hepburn", "val": 0.5}, {"name": "Garrett Temple", "val": 0.4}, {"name": "Markelle Fultz", "val": 0.2}] },
      ast: { name: "Scottie Barnes", val: 5.9, all: [{"name": "Scottie Barnes", "val": 5.9}, {"name": "Immanuel Quickley", "val": 5.9}, {"name": "Jamal Shead", "val": 5.4}, {"name": "Brandon Ingram", "val": 3.7}, {"name": "RJ Barrett", "val": 3.3}, {"name": "Jakob Poeltl", "val": 2.0}, {"name": "Collin Murray-Boyles", "val": 1.9}, {"name": "Sandro Mamukelashvili", "val": 1.9}, {"name": "Markelle Fultz", "val": 1.6}, {"name": "Ja'Kobe Walter", "val": 1.2}, {"name": "Chucky Hepburn", "val": 1.0}, {"name": "Ochai Agbaji", "val": 0.7}, {"name": "Gradey Dick", "val": 0.7}, {"name": "Jonathan Mogbo", "val": 0.6}, {"name": "Alijah Martin", "val": 0.5}, {"name": "Jamison Battle", "val": 0.4}, {"name": "Garrett Temple", "val": 0.4}, {"name": "Trayce Jackson-Davis", "val": 0.4}, {"name": "A.J. Lawson", "val": 0.3}, {"name": "Mo Bamba", "val": 0.0}] },
      stl: { name: "Scottie Barnes", val: 1.4, all: [{"name": "Scottie Barnes", "val": 1.4}, {"name": "Immanuel Quickley", "val": 1.3}, {"name": "Ja'Kobe Walter", "val": 1.0}, {"name": "Jakob Poeltl", "val": 0.9}, {"name": "Collin Murray-Boyles", "val": 0.9}, {"name": "Jamal Shead", "val": 0.9}, {"name": "Sandro Mamukelashvili", "val": 0.8}, {"name": "Brandon Ingram", "val": 0.8}, {"name": "RJ Barrett", "val": 0.7}, {"name": "Gradey Dick", "val": 0.6}, {"name": "A.J. Lawson", "val": 0.5}, {"name": "Chucky Hepburn", "val": 0.5}, {"name": "Ochai Agbaji", "val": 0.4}, {"name": "Markelle Fultz", "val": 0.4}, {"name": "Alijah Martin", "val": 0.3}, {"name": "Jonathan Mogbo", "val": 0.3}, {"name": "Garrett Temple", "val": 0.2}, {"name": "Trayce Jackson-Davis", "val": 0.2}, {"name": "Jamison Battle", "val": 0.1}, {"name": "Mo Bamba", "val": 0.0}] },
      blk: { name: "Scottie Barnes", val: 1.5, all: [{"name": "Scottie Barnes", "val": 1.5}, {"name": "Collin Murray-Boyles", "val": 0.9}, {"name": "Jakob Poeltl", "val": 0.7}, {"name": "Brandon Ingram", "val": 0.7}, {"name": "Sandro Mamukelashvili", "val": 0.5}, {"name": "Mo Bamba", "val": 0.5}, {"name": "Trayce Jackson-Davis", "val": 0.3}, {"name": "RJ Barrett", "val": 0.3}, {"name": "Ochai Agbaji", "val": 0.3}, {"name": "Alijah Martin", "val": 0.2}, {"name": "Jamal Shead", "val": 0.2}, {"name": "Ja'Kobe Walter", "val": 0.2}, {"name": "Jonathan Mogbo", "val": 0.2}, {"name": "A.J. Lawson", "val": 0.2}, {"name": "Immanuel Quickley", "val": 0.1}, {"name": "Gradey Dick", "val": 0.1}, {"name": "Garrett Temple", "val": 0.1}, {"name": "Chucky Hepburn", "val": 0.0}, {"name": "Jamison Battle", "val": 0.0}, {"name": "Markelle Fultz", "val": 0.0}] },
    },
    avail: [
      { name: "Jamal Shead", g: 82 },
      { name: "Scottie Barnes", g: 80 },
      { name: "Sandro Mamukelashvili", g: 80 },
      { name: "Brandon Ingram", g: 77 },
      { name: "Gradey Dick", g: 76 },
      { name: "Ja'Kobe Walter", g: 72 },
      { name: "Immanuel Quickley", g: 70 },
      { name: "Jamison Battle", g: 61 },
      { name: "RJ Barrett", g: 57 },
      { name: "Collin Murray-Boyles", g: 57 },
      { name: "Jakob Poeltl", g: 46 },
      { name: "Ochai Agbaji", g: 42 },
      { name: "Jonathan Mogbo", g: 40 },
      { name: "A.J. Lawson", g: 24 },
      { name: "Alijah Martin", g: 23 },
      { name: "Garrett Temple", g: 22 },
      { name: "Trayce Jackson-Davis", g: 17 },
