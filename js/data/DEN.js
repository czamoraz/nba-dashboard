...
window.SEASON_DATA = {
  ...
  "2025-26": {
    ...
    conf_rank: 3,
    games: buildGames(
      "LWWWLWWWWWWWLWWLWLWLWWWWWWLWLWLLWLLWWLWWWWLLWWLWWLLLWLWLWLWLLWWLLWWLWLWWWWWWWWW",
      ["Golden State Warriors", "Phoenix Suns", "Minnesota Timberwolves", "New Orleans Pelicans", "Portland Trail Blazers", "Sacramento Kings", "Miami Heat", "Golden State Warriors", "Indiana Pacers", "Sacramento Kings", "Los Angeles Clippers", "Minnesota Timberwolves", "Chicago Bulls", "New Orleans Pelicans", "Houston Rockets", "Sacramento Kings", "Memphis Grizzlies", "San Antonio Spurs", "Phoenix Suns", "Dallas Mavericks", "Indiana Pacers", "Atlanta Hawks", "Charlotte Hornets", "Sacramento Kings", "Houston Rockets", "Orlando Magic", "Houston Rockets", "Utah Jazz", "Dallas Mavericks", "Minnesota Timberwolves", "Orlando Magic", "Miami Heat", "Toronto Raptors", "Cleveland Cavaliers", "Brooklyn Nets", "Philadelphia 76ers", "Boston Celtics", "Atlanta Hawks", "Milwaukee Bucks", "New Orleans Pelicans", "Dallas Mavericks", "Washington Wizards", "Charlotte Hornets", "Los Angeles Lakers", "Washington Wizards", "Milwaukee Bucks", "Detroit Pistons", "Brooklyn Nets", "Los Angeles Clippers", "Oklahoma City Thunder", "Detroit Pistons", "New York Knicks", "Chicago Bulls", "Cleveland Cavaliers", "Memphis Grizzlies", "Los Angeles Clippers", "Portland Trail Blazers", "Golden State Warriors", "Boston Celtics", "Oklahoma City Thunder", "Minnesota Timberwolves", "Utah Jazz", "Los Angeles Lakers", "New York Knicks", "Oklahoma City Thunder", "Houston Rockets", "San Antonio Spurs", "Los Angeles Lakers", "Philadelphia 76ers", "Memphis Grizzlies", "Toronto Raptors", "Portland Trail Blazers", "Phoenix Suns", "Dallas Mavericks", "Utah Jazz", "Golden State Warriors", "Utah Jazz", "San Antonio Spurs", "Portland Trail Blazers"],
      [131, 133, 127, 122, 107, 130, 122, 129, 117, 122, 130, 123, 127, 125, 112, 123, 125, 136, 130, 121, 135, 134, 115, 136, 128, 126, 101, 135, 130, 142, 126, 123, 106, 108, 115, 125, 114, 87, 108, 122, 118, 121, 87, 107, 107, 102, 107, 107, 122, 111, 121, 127, 136, 117, 122, 114, 157, 117, 103, 121, 108, 128, 120, 103, 126, 129, 136, 125, 124, 118, 121, 128, 125, 142, 135, 116, 130, 136, 137],
      [-6, 22, 13, 34, -2, 6, 10, 25, 17, 14, 14, 11, -3, 7, 3, -5, 10, -3, 18, -10, 15, 1, 9, 31, 3, 11, -14, 23, -1, 4, -1, -24, 3, -5, -12, 1, 4, -23, 4, 6, 9, 6, -23, -8, 10, 2, -2, 4, 13, -10, -3, -7, 16, -2, 6, -1, 54, -11, 19, -6, -9, 3, 7, -39, -3, 36, 5, -2, 28, -7, 6, 16, 2, 7, 6, 23, 13, 2, 5]
    ),
    leaders: {
      pts: { name: "Nikola Jokić", val: 28.0, all: [{"name": "Nikola Jokić", "val": 28.0}, {"name": "Jamal Murray", "val": 25.4}, {"name": "Aaron Gordon", "val": 16.5}, {"name": "Peyton Watson", "val": 14.6}, {"name": "Tim Hardaway Jr.", "val": 13.5}, {"name": "Cameron Johnson", "val": 12.1}, {"name": "Christian Braun", "val": 11.9}, {"name": "Jonas Valančiūnas", "val": 8.3}, {"name": "Bruce Brown", "val": 7.7}, {"name": "Julian Strawther", "val": 6.6}, {"name": "Spencer Jones", "val": 5.5}, {"name": "Jalen Pickett", "val": 4.9}, {"name": "DaRon Holmes", "val": 4.0}, {"name": "Zeke Nnaji", "val": 3.7}, {"name": "Hunter Tyson", "val": 2.2}, {"name": "KJ Simpson", "val": 1.3}, {"name": "Curtis Jones", "val": 1.3}, {"name": "David Roddy", "val": 1.3}, {"name": "Tyus Jones", "val": 1.1}] },
      reb: { name: "Nikola Jokić", val: 12.9, all: [{"name": "Nikola Jokić", "val": 12.9}, {"name": "Aaron Gordon", "val": 5.9}, {"name": "Christian Braun", "val": 4.9}, {"name": "Peyton Watson", "val": 4.9}, {"name": "Jonas Valančiūnas", "val": 4.8}, {"name": "Jamal Murray", "val": 4.4}, {"name": "Cameron Johnson", "val": 3.8}, {"name": "Bruce Brown", "val": 3.8}, {"name": "Spencer Jones", "val": 3.3}, {"name": "Tim Hardaway Jr.", "val": 2.6}, {"name": "Zeke Nnaji", "val": 2.6}, {"name": "Jalen Pickett", "val": 2.3}, {"name": "Julian Strawther", "val": 1.9}, {"name": "Hunter Tyson", "val": 1.7}, {"name": "David Roddy", "val": 1.7}, {"name": "DaRon Holmes", "val": 1.4}, {"name": "KJ Simpson", "val": 1.3}, {"name": "Curtis Jones", "val": 0.7}, {"name": "Tyus Jones", "val": 0.6}] },
      ast: { name: "Nikola Jokić", val: 10.9, all: [{"name": "Nikola Jokić", "val": 10.9}, {"name": "Jamal Murray", "val": 7.2}, {"name": "Christian Braun", "val": 2.8}, {"name": "Aaron Gordon", "val": 2.6}, {"name": "Cameron Johnson", "val": 2.5}, {"name": "Jalen Pickett", "val": 2.2}, {"name": "Peyton Watson", "val": 2.1}, {"name": "Bruce Brown", "val": 2.0}, {"name": "KJ Simpson", "val": 2.0}, {"name": "Tim Hardaway Jr.", "val": 1.3}, {"name": "Jonas Valančiūnas", "val": 1.1}, {"name": "Julian Strawther", "val": 1.0}, {"name": "Spencer Jones", "val": 0.8}, {"name": "Hunter Tyson", "val": 0.8}, {"name": "DaRon Holmes", "val": 0.7}, {"name": "Tyus Jones", "val": 0.7}, {"name": "David Roddy", "val": 0.7}, {"name": "Curtis Jones", "val": 0.6}, {"name": "Zeke Nnaji", "val": 0.5}] },
      stl: { name: "Nikola Jokić", val: 1.4, all: [{"name": "Nikola Jokić", "val": 1.4}, {"name": "Bruce Brown", "val": 1.0}, {"name": "Jamal Murray", "val": 0.9}, {"name": "Peyton Watson", "val": 0.9}, {"name": "Spencer Jones", "val": 0.8}, {"name": "Christian Braun", "val": 0.7}, {"name": "Cameron Johnson", "val": 0.7}, {"name": "Aaron Gordon", "val": 0.6}, {"name": "Tim Hardaway Jr.", "val": 0.5}, {"name": "Julian Strawther", "val": 0.4}, {"name": "Zeke Nnaji", "val": 0.3}, {"name": "KJ Simpson", "val": 0.3}, {"name": "Jalen Pickett", "val": 0.3}, {"name": "David Roddy", "val": 0.3}, {"name": "Jonas Valančiūnas", "val": 0.2}, {"name": "Hunter Tyson", "val": 0.1}, {"name": "Tyus Jones", "val": 0.1}, {"name": "Curtis Jones", "val": 0.1}, {"name": "DaRon Holmes", "val": 0.0}] },
      blk: { name: "Peyton Watson", val: 1.1, all: [{"name": "Peyton Watson", "val": 1.1}, {"name": "Nikola Jokić", "val": 0.8}, {"name": "Jonas Valančiūnas", "val": 0.5}, {"name": "Spencer Jones", "val": 0.5}, {"name": "Jamal Murray", "val": 0.4}, {"name": "Cameron Johnson", "val": 0.4}, {"name": "Zeke Nnaji", "val": 0.4}, {"name": "Christian Braun", "val": 0.3}, {"name": "Aaron Gordon", "val": 0.3}, {"name": "DaRon Holmes", "val": 0.2}, {"name": "Bruce Brown", "val": 0.2}, {"name": "Jalen Pickett", "val": 0.1}, {"name": "Julian Strawther", "val": 0.1}, {"name": "Tim Hardaway Jr.", "val": 0.1}, {"name": "Hunter Tyson", "val": 0.0}, {"name": "KJ Simpson", "val": 0.0}, {"name": "Tyus Jones", "val": 0.0}, {"name": "Curtis Jones", "val": 0.0}, {"name": "David Roddy", "val": 0.0}] },
    },
    avail: [
      { name: "Bruce Brown", g: 79 },
      { name: "Tim Hardaway Jr.", g: 78 },
      { name: "Jamal Murray", g: 74 },
      { name: "Spencer Jones", g: 64 },
      { name: "Nikola Jokić", g: 63 },
      { name: "Jonas Valančiūnas", g: 62 },
      { name: "Julian Strawther", g: 54 },
      { name: "Peyton Watson", g: 54 },
      { name: "Cameron Johnson", g: 53 },
      { name: "Zeke Nnaji", g: 49 },
      { name: "Jalen Pickett", g: 47 },
      { name: "Christian Braun", g: 43 },
      { name: "Aaron Gordon", g: 35 },
      { name: "DaRon Holmes", g: 22 },
      { name: "Hunter Tyson", g: 21 },
      { name: "Tyus Jones", g: 9 },
      { name: "Curtis Jones", g: 7 },
      { name: "KJ Simpson", g: 4 },
