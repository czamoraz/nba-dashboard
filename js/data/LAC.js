...
window.SEASON_DATA = {
  ...
  "2025-26": {
    ...
    conf_rank: 8,
    games: buildGames(
      "LWWLWLLLLLLWLLLWLLLLLWLLLLLWWWWWWLWLWWWWWWLWWWLWLLWWLWWLLLWWWLWWWWLLLLWWWWWLLWW",
      ...
      [108, 129, 114, 79, 126, 119, 107, 102, 103, 102, 116, 133, 118, 108, 101, 131, 105, 118, 107, 110, 123, 115, 98, 106, 113, 103, 101, 103, 128, 119, 112, 131, 118, 115, 103, 111, 121, 98, 117, 119, 121, 110, 110, 112, 126, 115, 109, 117, 113, 91, 114, 115, 95, 105, 115, 122, 109, 88, 137, 114, 130, 112, 123, 126, 153, 119, 109, 115, 109, 99, 138, 129, 119, 114, 127, 104, 99, 138, 116],
      [-21, 27, 7, -19, 2, -1, -19, -13, -11, -3, -14, 6, -3, -2, -28, 15, -15, -17, -5, -4, -17, 23, -9, -3, -2, -18, -21, 15, 20, 16, 13, 41, 17, -31, 1, -12, 16, 6, 8, 14, 4, 4, -28, 8, 37, 12, -13, 24, -15, -33, 3, 19, -7, 3, 1, -3, -2, -6, 20, 13, 23, -4, 3, 8, 25, 11, -9, -4, -15, -6, 7, 33, 25, 1, 14, -10, -19, 29, 13]
    ),
    leaders: {
      pts: { name: "Kawhi Leonard", val: 28.1, all: [{"name": "Kawhi Leonard", "val": 28.1}, {"name": "James Harden", "val": 25.4}, {"name": "Darius Garland", "val": 20.4}, {"name": "Bennedict Mathurin", "val": 18.3}, {"name": "Ivica Zubac", "val": 14.4}, {"name": "John Collins", "val": 13.7}, {"name": "Derrick Jones Jr.", "val": 10.3}, {"name": "Jordan Miller", "val": 9.7}, {"name": "Brook Lopez", "val": 8.2}, {"name": "Bradley Beal", "val": 8.2}, {"name": "Isaiah Jackson", "val": 7.5}, {"name": "Kris Dunn", "val": 7.4}, {"name": "Kobe Sanders", "val": 7.1}, {"name": "Bogdan Bogdanović", "val": 7.0}, {"name": "Patrick Baldwin Jr.", "val": 5.0}, {"name": "Yanic Konan Niederhäuser", "val": 4.3}, {"name": "Nicolas Batum", "val": 4.0}, {"name": "Dalano Banton", "val": 3.0}, {"name": "Norchad Omier", "val": 3.0}, {"name": "Cam Christie", "val": 2.9}, {"name": "Kobe Brown", "val": 2.9}, {"name": "Chris Paul", "val": 2.9}, {"name": "Sean Pedulla", "val": 2.2}, {"name": "TyTy Washington Jr.", "val": 1.5}, {"name": "Jahmyl Telfort", "val": 0.1}, {"name": "RayJ Dennis", "val": 0.0}] },
      reb: { name: "Ivica Zubac", val: 11.0, all: [{"name": "Ivica Zubac", "val": 11.0}, {"name": "Kawhi Leonard", "val": 6.3}, {"name": "Bennedict Mathurin", "val": 5.7}, {"name": "John Collins", "val": 5.3}, {"name": "James Harden", "val": 4.8}, {"name": "Isaiah Jackson", "val": 4.6}, {"name": "Brook Lopez", "val": 3.5}, {"name": "Derrick Jones Jr.", "val": 3.4}, {"name": "Kris Dunn", "val": 3.3}, {"name": "Jordan Miller", "val": 3.0}, {"name": "Yanic Konan Niederhäuser", "val": 2.9}, {"name": "Bogdan Bogdanović", "val": 2.5}, {"name": "Nicolas Batum", "val": 2.5}, {"name": "Kobe Sanders", "val": 2.3}, {"name": "Darius Garland", "val": 2.2}, {"name": "RayJ Dennis", "val": 2.0}, {"name": "Chris Paul", "val": 1.8}, {"name": "Kobe Brown", "val": 1.6}, {"name": "Cam Christie", "val": 1.5}, {"name": "Norchad Omier", "val": 1.2}, {"name": "Bradley Beal", "val": 0.8}, {"name": "Patrick Baldwin Jr.", "val": 0.5}, {"name": "Dalano Banton", "val": 0.5}, {"name": "Sean Pedulla", "val": 0.5}, {"name": "TyTy Washington Jr.", "val": 0.4}, {"name": "Jahmyl Telfort", "val": 0.4}] },
      ast: { name: "James Harden", val: 8.1, all: [{"name": "James Harden", "val": 8.1}, {"name": "Darius Garland", "val": 6.4}, {"name": "Kawhi Leonard", "val": 3.6}, {"name": "Kris Dunn", "val": 3.6}, {"name": "Chris Paul", "val": 3.3}, {"name": "Bennedict Mathurin", "val": 2.4}, {"name": "Bogdan Bogdanović", "val": 2.3}, {"name": "Jordan Miller", "val": 2.2}, {"name": "Ivica Zubac", "val": 2.2}, {"name": "Bradley Beal", "val": 1.7}, {"name": "Kobe Sanders", "val": 1.6}, {"name": "Derrick Jones Jr.", "val": 1.4}, {"name": "Brook Lopez", "val": 1.3}, {"name": "Isaiah Jackson", "val": 1.2}, {"name": "TyTy Washington Jr.", "val": 1.1}, {"name": "John Collins", "val": 1.0}, {"name": "Dalano Banton", "val": 1.0}, {"name": "Nicolas Batum", "val": 0.9}, {"name": "Kobe Brown", "val": 0.8}, {"name": "Sean Pedulla", "val": 0.8}, {"name": "Cam Christie", "val": 0.6}, {"name": "Norchad Omier", "val": 0.4}, {"name": "Yanic Konan Niederhäuser", "val": 0.3}, {"name": "Jahmyl Telfort", "val": 0.1}, {"name": "Patrick Baldwin Jr.", "val": 0.0}, {"name": "RayJ Dennis", "val": 0.0}] },
      stl: { name: "Kawhi Leonard", val: 1.9, all: [{"name": "Kawhi Leonard", "val": 1.9}, {"name": "Kris Dunn", "val": 1.6}, {"name": "James Harden", "val": 1.3}, {"name": "Bennedict Mathurin", "val": 1.1}, {"name": "Darius Garland", "val": 1.1}, {"name": "John Collins", "val": 0.9}, {"name": "Derrick Jones Jr.", "val": 0.9}, {"name": "Jordan Miller", "val": 0.8}, {"name": "Kobe Sanders", "val": 0.7}, {"name": "Chris Paul", "val": 0.7}, {"name": "Nicolas Batum", "val": 0.7}, {"name": "Brook Lopez", "val": 0.6}, {"name": "Isaiah Jackson", "val": 0.6}, {"name": "Bradley Beal", "val": 0.5}, {"name": "Bogdan Bogdanović", "val": 0.5}, {"name": "Dalano Banton", "val": 0.5}, {"name": "Ivica Zubac", "val": 0.4}, {"name": "Cam Christie", "val": 0.3}, {"name": "Kobe Brown", "val": 0.3}, {"name": "TyTy Washington Jr.", "val": 0.3}, {"name": "Norchad Omier", "val": 0.2}, {"name": "Yanic Konan Niederhäuser", "val": 0.1}, {"name": "Jahmyl Telfort", "val": 0.1}, {"name": "Patrick Baldwin Jr.", "val": 0.0}, {"name": "Sean Pedulla", "val": 0.0}, {"name": "RayJ Dennis", "val": 0.0}] },
      blk: { name: "Brook Lopez", val: 1.2, all: [{"name": "Brook Lopez", "val": 1.2}, {"name": "Isaiah Jackson", "val": 1.2}, {"name": "Derrick Jones Jr.", "val": 1.0}, {"name": "Ivica Zubac", "val": 0.8}, {"name": "John Collins", "val": 0.8}, {"name": "Yanic Konan Niederhäuser", "val": 0.7}, {"name": "James Harden", "val": 0.4}, {"name": "Kawhi Leonard", "val": 0.4}, {"name": "Nicolas Batum", "val": 0.3}, {"name": "Bennedict Mathurin", "val": 0.3}, {"name": "Darius Garland", "val": 0.3}, {"name": "Jordan Miller", "val": 0.2}, {"name": "Kris Dunn", "val": 0.2}, {"name": "TyTy Washington Jr.", "val": 0.1}, {"name": "Kobe Brown", "val": 0.1}, {"name": "Cam Christie", "val": 0.1}, {"name": "Kobe Sanders", "val": 0.1}, {"name": "Chris Paul", "val": 0.0}, {"name": "Bradley Beal", "val": 0.0}, {"name": "Bogdan Bogdanović", "val": 0.0}, {"name": "Patrick Baldwin Jr.", "val": 0.0}, {"name": "Dalano Banton", "val": 0.0}, {"name": "Sean Pedulla", "val": 0.0}, {"name": "Norchad Omier", "val": 0.0}, {"name": "RayJ Dennis", "val": 0.0}, {"name": "Jahmyl Telfort", "val": 0.0}] },
    },
    avail: [
      { name: "Kris Dunn", g: 79 },
      { name: "Brook Lopez", g: 72 },
      { name: "Nicolas Batum", g: 71 },
      { name: "John Collins", g: 66 },
      { name: "Kobe Sanders", g: 65 },
      { name: "Kawhi Leonard", g: 63 },
      { name: "Jordan Miller", g: 57 },
      { name: "Cam Christie", g: 53 },
      { name: "Derrick Jones Jr.", g: 47 },
      { name: "James Harden", g: 44 },
      { name: "Ivica Zubac", g: 43 },
      { name: "Yanic Konan Niederhäuser", g: 41 },
      { name: "Kobe Brown", g: 34 },
      { name: "Bennedict Mathurin", g: 23 },
      { name: "Bogdan Bogdanović", g: 22 },
      { name: "Darius Garland", g: 17 },
      { name: "Isaiah Jackson", g: 17 },
      { name: "Chris Paul", g: 16 },
      { name: "TyTy Washington Jr.", g: 14 },
      { name: "Jahmyl Telfort", g: 8 },
      { name: "Bradley Beal", g: 6 },
      { name: "Sean Pedulla", g: 6 },
      { name: "Norchad Omier", g: 5 },
      { name: "Patrick Baldwin Jr.", g: 2 },
